...
const Delivery = () => {
  return (
    <div className='w-full bg-black py-16 px-4'>
        <h3 className='text-[#FFE600]  font-bold text-2xl text-center'>Quick Delivery App</h3>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 text-white'>
            ...
            <div className='flex flex-col justify-center'>
                <p className='text-[#FFE600] font-bold'>Get The App</p>
            ...
            eveniet ex deserunt fuga?
                ...
                <button className='bg-[#FFE600] text-black w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3'> Get Started</button>
            </div>
        </div>
    </div>
  )
